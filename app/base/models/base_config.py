...
class BaseConfig(models.Model):
    ...
    main_company_id = models.ForeignKey(Company, on_delete=models.CASCADE, null=True, blank=True)
    open_menu = models.BooleanField('Menu Abierto', default=True)
    load_data = models.BooleanField('Data Cargada', default=False)
    type_share = models.CharField(
        _("Type Share"), choices=SHARE_PRODUCT_CHOICE, max_length=64, default='no')
