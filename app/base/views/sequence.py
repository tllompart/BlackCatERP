...
from .web_father import (FatherCreateView, FatherDeleteView, FatherDetailView, FatherListView,
                         FatherUpdateView)
...
OBJECT_FORM_FIELDS = ['name', 'prefix', 'padding',
                      'initial', 'increment', 'reset', 'next_val']
